...
function Pagination(_ref) {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, totalPages > 0 ? /*#__PURE__*/React.createElement("nav", {
    role: "navigation",
  ...
  }, currentPage === 1 ? /*#__PURE__*/React.createElement("span", {
    ...
    d: "M7.707 14.707a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414l4-4a1 1 0 011.414 1.414L5.414 9H17a1 1 0 110 2H5.414l2.293 2.293a1 1 0 010 1.414z",
    clipRule: "evenodd"
  })), "Previous"), currentPage < totalPages ? /*#__PURE__*/React.createElement("button", {
    onClick: () => handlePageClick(currentPage + 1),
  ...
  }, firstItem), " to", " ", /*#__PURE__*/React.createElement("span", {
    className: "font-medium"
  }, lastItem), " of", " ", /*#__PURE__*/React.createElement("span", {
    className: "font-medium"
  }, totalItems), " results")), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("span", {
    ...
    d: "M7.707 14.707a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414l4-4a1 1 0 011.414 1.414L5.414 9H17a1 1 0 110 2H5.414l2.293 2.293a1 1 0 010 1.414z",
    clipRule: "evenodd"
  }))), currentPage > 3 ? /*#__PURE__*/React.createElement("button", {
  ...
  }, "1") : null, currentPage > 4 ? /*#__PURE__*/React.createElement("span", {
    "aria-disabled": "true",
    ...
    if (page >= currentPage - 2 && page <= currentPage + 2) {
      return page === currentPage ? /*#__PURE__*/React.createElement("span", {
        key: i,
        "aria-current": "page",
    ...
    return null;
  }), currentPage < totalPages - 3 ? /*#__PURE__*/React.createElement("span", {
    "aria-disabled": "true",
    className: "py-2 px-3 leading-tight text-gray-500 bg-skin-base border border-gray-300 hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white"
  }, "...") : null, currentPage < totalPages - 2 ? /*#__PURE__*/React.createElement("button", {
    onClick: () => handlePageClick(totalPages),
    className: "relative inline-flex items-center py-2 px-3 leading-tight text-gray-500 bg-skin-base border border-gray-300 cursor-pointer hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white",
    "aria-label": "{{ __('Go to page :page', ['page' => totalPages]) }}"
  }, totalPages) : null, currentPage < totalPages ? /*#__PURE__*/React.createElement("button", {
    onClick: () => handlePageClick(currentPage + 1),
    rel: "next",
